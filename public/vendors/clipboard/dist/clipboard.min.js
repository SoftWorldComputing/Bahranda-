...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2020/01/cropped-UrbanUI-Favicon-270x270.png" />
  ...
  display: none;
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="81d4fa4f35" /><input type="hidden" name="_wp_http_referer" value="/victory/vendors/clipboard/dist/clipboard.min.js" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="d110f77a14" /><input type="hidden" name="_wp_http_referer" value="/victory/vendors/clipboard/dist/clipboard.min.js" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="be46a70b34" /><input type="hidden" name="_wp_http_referer" value="/victory/vendors/clipboard/dist/clipboard.min.js" />  
